...
class LabelSmoothAddFocalLoss(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            activated (bool, optional): Whether the input is activated.
                ...
                Defaults to False.
        """
        super(LabelSmoothAddFocalLoss, self).__init__()
    ...
    def forward(self,
        ...
        # - - - - - - - - -
        n = pred.size()[-1]
        log_preds_1 = F.log_softmax(pred, dim=-1)
        loss_1 = reduce_loss(-log_preds_1.sum(dim=-1), self.reduction)
        nll = F.nll_loss(log_preds_1, target, reduction=self.reduction)
        loss_ls = linear_combination(loss_1 / n, nll, self.epsilon)
        # - - - - - - - - -
