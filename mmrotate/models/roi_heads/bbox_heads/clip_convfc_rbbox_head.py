...
class ClipRotatedConvFCBBoxHead(RotatedBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(ClipRotatedConvFCBBoxHead, self).__init__(
        ...
        logger.success('build logit scale: {}'.format(model.logit_scale))
...
# 改这里
@ROTATED_HEADS.register_module()
class ClipRotatedShared2FCBBoxHead(ClipRotatedConvFCBBoxHead):
    """Shared2FC RBBox head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(ClipRotatedShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
...
@ROTATED_HEADS.register_module()
class ClipRotatedKFIoUShared2FCBBoxHead(ClipRotatedConvFCBBoxHead):
    """KFIoU RoI head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(ClipRotatedKFIoUShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
