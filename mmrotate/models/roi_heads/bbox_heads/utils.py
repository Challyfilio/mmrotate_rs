...
from mmrotate.models.roi_heads.bbox_heads.text_encoder import CLIPTextEncoder
...
def get_text_embeddings(dataset='dota',
    ...
    text_encoder = CLIPTextEncoder(model_name='RN50')
    text_encoder.eval()
    ...
    embeddings = text_encoder(texts).cuda()
    return embeddings
