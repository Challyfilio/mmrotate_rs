...
class LSKFPNV2(nn.Module):
    ...
    def forward(self, inputs: Tuple[Tensor]) -> tuple:
        ...
        x5 = self.egca4(x5)  # [2, 2048, 32, 32]
        x4 = self.egca3(x4)  # [2, 1024, 64, 64]
        x3 = self.egca2(x3)  # [2, 512, 128, 128]
        x2 = self.egca1(x2)  # [2, 256, 256, 256]
        ...
        adj5 = self.adjust5(dsc5)  # [2, 256, 32, 32]
        adj4 = self.adjust4(dsc4)  # [2, 256, 64, 64]
        adj3 = self.adjust3(dsc3)  # [2, 256, 128, 128]
        adj2 = self.adjust2(dsc2)  # [2, 256, 256, 256]
...
if __name__ == "__main__":
    ...
    model = LSKFPNV2(in_channels=channels50, out_channels=256, num_outs=5)
